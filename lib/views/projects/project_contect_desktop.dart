          ...
          Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                AppsRow(
                  tag: 'Swap',
                  playstoreLink: 'https://play.google.com/store/apps/details?id=com.swap.swap_ecommerce',
                ...
                AppsRow(
                  ...
                  playstoreLink: 'https://play.google.com/store/apps/details?id=com.passwordmanager.droidpass&hl=bn',
                  buttonText: 'GET IT ON GOOGLE PLAY',
                ...
                AppsRow(
                  ...
                  playstoreLink: 'https://play.google.com/store/apps/details?id=com.aust.rakib.passwordmanager.pro',
                  buttonText: 'GET IT ON GOOGLE PLAY',
                ...
                AppsRow(
                  ...
                  playstoreLink: 'https://play.google.com/store/apps/details?id=com.appcreativeps.creative_problem_solver',
                  buttonText: 'GET IT ON GOOGLE PLAY',
                ...
                AppsRow(
                  ...
                  playstoreLink: 'https://play.google.com/store/apps/details?id=com.osmannoah.on_site_soccer_analysis',
                  buttonText: 'GET IT ON GOOGLE PLAY',
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    RaisedButton(
                      child: Text('App Store',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.white),),
...
AppsRow({tag,playstoreLink,buttonText,tag1,link1,buttonText1,tag2,link2,buttonText2,image,image1,image2,tag3,link3,buttonText3,image3}){
  return    Row(
    children: <Widget>[
      tag != null ? AppsItem(tag,buttonText,playstoreLink,image,tag == 'DroidPass Password Manager'? 'https://apps.apple.com/us/app/id1490618521' : tag == 'Swap'? 'https://apps.apple.com/us/app/swap-bd/id1499768718' : ''): Container(),
...
Expanded AppsItem(tag,buttonText,playstoreLink,image,appStoreLink) {
  return Expanded(
      ...
      child: Padding(
        ...
        child: InkWell(
          onTap: (){
            showAlertDialog(locator<NavigationService>().scaffoldKey.currentContext,tag,buttonText,playstoreLink,image,appStoreLink);
...
showAlertDialog(BuildContext context,tag,buttonText,playStoreLink,image,appstoreLink) {
