            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  skillPercentIndicatorDesktop('CSS',.87,Colors.green),
                  skillPercentIndicatorDesktop('HTML',.9,Colors.green),
                  skillPercentIndicatorDesktop('UI Design',.9,Colors.green),
                  skillPercentIndicatorDesktop('Illustrator',.51,Colors.green),
                ],
              ),
            ),
          ),
